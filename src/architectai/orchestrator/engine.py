"""Agent Orchestrator Engine for ArchitectAI.
...
class Agent(ABC):
    ...
    def __init__(self, agent_type: AgentType, config: Optional[Dict[str, Any]] = None):
        ...
        self.logger = logging.getLogger(f"architectai.agents.{agent_type.value}")
...
class AgentOrchestrator:
    ...
    def _setup_json_logging(self) -> None:
        ...
        self.action_logger = logging.getLogger("architectai.orchestrator.actions")
